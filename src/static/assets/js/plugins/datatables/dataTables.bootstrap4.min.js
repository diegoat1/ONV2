      ...
      var u,
        ...
        w = function (e, a) {
          for (
            ...
            if (((s = a[o]), Array.isArray(s))) w(e, s);
            else {
              switch (((p = u = ""), s)) {
                case "ellipsis":
                  (u = "&#x2026;"), (p = "disabled");
                  break;
                case "first":
                  (u = b.sFirst), (p = s + (0 < l ? "" : " disabled"));
                  break;
                case "previous":
                  (u = b.sPrevious), (p = s + (0 < l ? "" : " disabled"));
                  break;
                case "next":
                  (u = b.sNext), (p = s + (l < c - 1 ? "" : " disabled"));
                  break;
                case "last":
                  (u = b.sLast), (p = s + (l < c - 1 ? "" : " disabled"));
                  break;
                default:
                  (u = s + 1), (p = l === s ? "active" : "");
              }
              u &&
                ((t = h("<li>", {
                  ...
                  .appendTo(e)),
                i.oApi._fnBindAction(t, { action: s }, n),
                x++);
            }
        };
      try {
