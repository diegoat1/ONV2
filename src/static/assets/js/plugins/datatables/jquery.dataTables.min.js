...
!(function (n) {
  ...
  function n(t, e, n) {
    return (
      !!r(t) ||
      ((r((a = t)) || "string" == typeof a) && !!i(g(t), e, n)) ||
      null
    );
    var a;
  }
        ...
        this.each(function () {
          ...
          if ("table" == this.nodeName.toLowerCase()) {
            ...
            (f.nTable = this),
              ...
              (f.oInit = a),
              n.push(f),
              (f.oInstance = 1 === y.length ? y : i.dataTable()),
              I(a),
              A(a.oLanguage),
              a.aLengthMenu &&
                !a.iDisplayLength &&
              ...
              le(f.oLanguage, a, "fnInfoCallback"),
              ce(f, "aoDrawCallback", a.fnDrawCallback, "user"),
              ce(f, "aoServerParams", a.fnServerParams, "user"),
              ce(f, "aoStateSaveParams", a.fnStateSaveParams, "user"),
              ce(f, "aoStateLoadParams", a.fnStateLoadParams, "user"),
              ce(f, "aoStateLoaded", a.fnStateLoaded, "user"),
              ce(f, "aoRowCallback", a.fnRowCallback, "user"),
              ce(f, "aoRowCreatedCallback", a.fnCreatedRow, "user"),
              ce(f, "aoHeaderCallback", a.fnHeaderCallback, "user"),
              ce(f, "aoFooterCallback", a.fnFooterCallback, "user"),
              ce(f, "aoInitComplete", a.fnInitComplete, "user"),
              ce(f, "aoPreDrawCallback", a.fnPreDrawCallback, "user"),
              (f.rowIdFn = Y(a.rowId)),
              L(f);
            var d = f.oClasses;
            j.extend(d, w.ext.classes, a.oClasses),
              i.addClass(d.sTable),
              f.iInitDisplayStart === N &&
                ((f.iInitDisplayStart = a.iDisplayStart),
                (f._iDisplayStart = a.iDisplayStart)),
              null !== a.iDeferLoading &&
                ((f.bDeferLoading = !0),
                (p = Array.isArray(a.iDeferLoading)),
                (f._iRecordsDisplay = p ? a.iDeferLoading[0] : a.iDeferLoading),
                (f._iRecordsTotal = p ? a.iDeferLoading[1] : a.iDeferLoading));
            var h = f.oLanguage;
            j.extend(!0, h, a.oLanguage),
              h.sUrl &&
                (j.ajax({
                  dataType: "json",
                  url: h.sUrl,
            ...
            var p = f.asStripeClasses,
              g = i.children("tbody").find("tr").eq(0);
            -1 !==
              j.inArray(
                !0,
              ...
              p = function () {
                if (a.aaSorting === N) {
                  ...
                  for (r = 0, l = t.length; r < l; r++)
                    t[r][1] = f.aoColumns[r].asSorting[0];
                }
                ee(f),
                  v.bSort &&
                ...
                var e = i.children("caption").each(function () {
                  ...
                  n = i.children("thead");
                0 === n.length && (n = j("<thead/>").appendTo(i)),
                  (f.nTHead = n[0]);
                n = i.children("tbody");
                0 === n.length && (n = j("<tbody/>").appendTo(i)),
                  (f.nTBody = n[0]);
                n = i.children("tfoot");
                if (
                  (0 === n.length &&
                    ...
                    (n = j("<tfoot/>").appendTo(i)),
                  0 === n.length || 0 === n.children().length
                    ? i.addClass(d.sNoFooter)
                    : 0 < n.length &&
                      ((f.nTFoot = n[0]), ct(f.aoFooter, f.nTFoot)),
                  a.aaData)
                )
        ...
        for (Array.isArray(d) || (d = [d]), i = 0, l = d.length; i < l; i++)
          if ("number" == typeof d[i] && 0 <= d[i]) {
            ...
            for (s = 0, u = f.length; s < u; s++)
              ("_all" != d[i] && !j(f[s].nTh).hasClass(d[i])) || a(s, c);
      }
  ...
  function lt(t) {
    ...
    if (-1 === j.inArray(!1, e)) {
      ...
      (t.bDrawing = !0),
        l !== N &&
          -1 !== l &&
          ((t._iDisplayStart = !s && l >= t.fnRecordsDisplay() ? 0 : l),
      ...
      if (0 !== u.length)
        for (
          var c = s ? 0 : e, f = s ? t.aoData.length : l, d = c;
          d < f;
          d++
        ) {
          var h = u[d],
          ...
          0 !== o &&
            ...
            p._sRowStripe != g &&
              ...
              (p._sRowStripe = g))),
            fe(t, "aoRowCallback", null, [b, p._aData, a, d, h]),
            n.push(b),
            a++;
        }
      else {
        ...
        1 == t.iDraw && "ajax" == pe(t)
          ? (c = i.sLoadingRecords)
          : i.sEmptyTable && 0 === t.fnRecordsTotal() && (c = i.sEmptyTable),
          (n[0] = j("<tr/>", { class: o ? r[0] : "" }).append(
            j("<td />", {
              valign: "top",
              colSpan: W(t),
  ...
  function dt(r, t, e) {
    ...
    j.isPlainObject(l) &&
      l.data &&
      ((u = "function" == typeof (n = l.data) ? n(t, r) : n),
      (t = "function" == typeof n && u ? u : j.extend(!0, t, u)),
      delete l.data);
    var u = {
      data: t,
      success: function (t) {
    ...
    (r.oAjaxData = t),
      ...
      r.fnServerData
        ...
        : "function" == typeof l
        ? (r.jqXHR = l.call(s, t, i, r))
        : ((r.jqXHR = j.ajax(j.extend(u, l))), (l.data = n));
  }
  function ht(e) {
    return (
      !e.bAjaxDataGet ||
    ...
    for (
      ...
      if (!(i = t.aoData[c])._aFilterData) {
        for (r = [], n = 0, a = l.length; n < a; n++)
          (e = l[n]).bSearchable
            ? ((o = J(t, c, n, "filter")),
              s[e.sType] && (o = s[e.sType](o)),
              null === o && (o = ""),
              "string" != typeof o && o.toString && (o = o.toString()))
            : (o = ""),
            o.indexOf &&
              -1 !== o.indexOf("&") &&
  ...
  function Xt(t) {
    var e,
      ...
      b = g.bScrollOversize,
      m = a.style.width;
    for (m && -1 !== m.indexOf("%") && (d = m), y = 0; y < c.length; y++)
      null !== (e = r[c[y]]).sWidth &&
    ...
    if (b || (!p && !l && !i && u == W(t) && u == f.length))
      ...
      for (var D = 0, y = 0; y < c.length; y++) {
        var _ = j(f[y]),
          ...
          _ = g.bBounding
            ? Math.ceil(f[y].getBoundingClientRect().width)
            : _.outerWidth();
    ...
    "number" == typeof i[0] && (i = t.aaSorting = [i]),
      n && t.oFeatures.bSortMulti
        ? -1 !== (n = j.inArray(e, H(i, "0")))
          ? (null === (r = o(i[n], !0)) && 1 === i.length && (r = 0),
            null === r ? i.splice(n, 1) : ((i[n][1] = l[r]), (i[n]._idx = r)))
      ...
      if (n.length && e && (e instanceof me || e.__dt_wrapper))
        for (var a, r = 0, o = n.length; r < o; r++)
          (e[(a = n[r]).name] =
            ...
            me.extend(t, e[a.name], a.propExt);
    }),
    (me.register = e =
      function (t, e) {
        if (Array.isArray(t))
          ...
          for (
            var r, o, i = t.split("."), l = ge, s = 0, u = i.length;
            s < u;
            s++
          ) {
            var c = (function (t, e) {
                ...
                ? ((c.val = e),
                  (c.type =
                    "function" == typeof e
                      ...
                      ? "object"
                      : "other"))
                : (l = o ? c.methodExt : c.propExt);
          }
      }),
    (me.registerPlural = t =
      function (t, e, n) {
        me.register(t, n),
          me.register(e, function () {
  ...
  e("tables()", function (t) {
    ...
    e("draw()", function (e) {
      return this.iterator("table", function (t) {
        "page" === e
          ? lt(t)
          : ("string" == typeof e && (e = "full-hold" !== e), st(t, !1 === e));
      });
    }),
    e("page()", function (e) {
      return e === N
  ...
  function De(t, e, n, a, r) {
    var o,
      ...
      d = typeof e;
    for (
      (e && "string" != d && "function" != d && e.length !== N) || (e = [e]),
        l = 0,
        s = e.length;
      l < s;
      l++
      ...
      for (
        ...
        (o = n("string" == typeof i[u] ? i[u].trim() : i[u])) &&
          o.length &&
          (f = f.concat(o));
    var h = p.selector[t];
    if (h.length) for (l = 0, s = h.length; l < s; l++) f = h[l](a, r, f);
    return b(f);
  }
  function ye(t) {
    return (
  ...
  e("cells()", function (g, t, b) {
    ...
    e("i18n()", function (t, e, n) {
      ...
      return (
        a === N && (a = e),
        n !== N && j.isPlainObject(a) && (a = a[n] !== N ? a[n] : a._),
        a.replace("%d", n)
      );
    }),
    (w.version = "1.10.22"),
    ...
    (w.defaults = {
      ...
      oLanguage: {
        ...
        sDecimal: "",
        sThousands: ",",
        sLengthMenu: "Mosntrando _MENU_ entradas",
  ...
  function Pe(t, e) {
    ...
    return (
      e <= a
        ...
        : (e - 1 - r <= t
            ? (n = f(e - (a - 2), e)).splice(0, 0, "ellipsis")
                ...
                if (((n = e[o]), Array.isArray(n))) {
                  ...
                  switch (((d = null), (h = n), (l = s.iTabIndex), n)) {
                    ...
                    case "last":
                      ...
                      break;
                    default:
                      (d = s.fnFormatNumber(n + 1)),
                        (h = c === n ? p.sPageButtonActive : "");
                  }
                  null !== d &&
                    (ue(
                      j("<a>", {
