...
!(function () {
      ...
      return (
        ...
        (l = [
            ...
            value: function () {
              jQuery(
                ...
                .on("click.pixelcave.helpers.core", function (e) {
                  ...
                  a.addClass("js-class-toggle-enabled").trigger("blur"),
          ...
          },
          {
            key: "coreScrollTo",
            value: function () {
              jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on(
                ...
                t.addClass("js-click-ripple-enabled")
                  ...
                  .on("click.pixelcave.helpers.core", function (e) {
                    var a,
                      ...
                      r,
                      l = "click-ripple";
                    0 === t.children("." + l).length
                      ? t.prepend('<span class="click-ripple"></span>')
                      : t.children("." + l).removeClass("animate"),
                      (a = t.children("." + l)).height() ||
                        a.width() ||
          ...
          },
          {
            ...
            value: function () {
              jQuery(".js-table-sections:not(.js-table-sections-enabled)").each(
                function (e, a) {
                  var t = jQuery(a);
                    ...
                    function (a) {
                      ...
                      t.prop("checked")
                        ? jQuery("tbody input:checkbox:checked", o).length ===
                          ...
                          jQuery("thead input:checkbox", o).prop("checked", !0)
          ...
          },
          {
            key: "summernote",
            value: function () {
              jQuery(".js-summernote-air:not(.js-summernote-air-enabled)").each(
                function (e, a) {
                  jQuery(a)
          ...
          },
          {
            key: "ckeditor5",
            value: function () {
              jQuery("#js-ckeditor5-inline:not(.js-ckeditor5-inline-enabled)")
                .length &&
                (InlineEditor.create(
                ...
                jQuery(
                  ...
                  jQuery("#js-ckeditor5-classic").addClass(
            ...
            value: function () {
              jQuery(".js-simplemde:not(.js-simplemde-enabled)").each(function (
                ...
                t.addClass("js-simplemde-enabled"),
                  new SimpleMDE({ element: t[0], autoDownloadFontAwesome: !1 });
              });
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(function (
                a,
                t
              ) {
                var r = jQuery(t),
                  ...
                  s = {
                    line: function () {
                      (i.type = l),
                        (i.lineWidth = r.data("line-width") || 2),
                        (i.lineColor = r.data("line-color") || "#0665d0"),
                        (i.fillColor = r.data("fill-color") || "#0665d0"),
                        (i.spotColor = r.data("spot-color") || "#495057"),
                        (i.minSpotColor =
                          r.data("min-spot-color") || "#495057"),
                        (i.maxSpotColor =
                          r.data("max-spot-color") || "#495057"),
                        (i.highlightSpotColor =
                          r.data("highlight-spot-color") || "#495057"),
                        (i.highlightLineColor =
                          r.data("highlight-line-color") || "#495057"),
                        (i.spotRadius = r.data("spot-radius") || 2),
                        (i.tooltipFormat = "{{prefix}}{{y}}{{suffix}}");
                    },
                    bar: function () {
                      (i.type = l),
                        (i.barWidth = r.data("bar-width") || 8),
                        (i.barSpacing = r.data("bar-spacing") || 6),
                        (i.barColor = r.data("bar-color") || "#0665d0"),
                        (i.tooltipFormat = "{{prefix}}{{value}}{{suffix}}");
                    },
                    pie: function () {
                      (i.type = l),
                        (i.sliceColors = [
                    ...
                    tristate: function () {
                      (i.type = l),
                        (i.barWidth = r.data("bar-width") || 8),
                        (i.barSpacing = r.data("bar-spacing") || 6),
                        (i.posBarColor = r.data("pos-bar-color") || "#82b54b"),
                        (i.negBarColor = r.data("neg-bar-color") || "#e04f1a");
                    },
                  };
                s[l]
                  ? (s[l](),
                    "line" === l &&
                      ((r.data("chart-range-min") >= 0 ||
                        r.data("chart-range-min")) &&
                        (i.chartRangeMin = r.data("chart-range-min")),
                      (r.data("chart-range-max") >= 0 ||
                        r.data("chart-range-max")) &&
                        (i.chartRangeMax = r.data("chart-range-max"))),
                    (i.width = r.data("width") || "120px"),
                    (i.height = r.data("height") || "80px"),
                    (i.tooltipPrefix = r.data("tooltip-prefix")
                      ? r.data("tooltip-prefix") + " "
                      : ""),
                    (i.tooltipSuffix = r.data("tooltip-suffix")
                    ...
                    jQuery(t).sparkline(r.data("points") || [0], i))
                  : console.log(
          ...
          },
          {
            ...
            value: (function (e) {
              ...
              jQuery(".js-flatpickr:not(.js-flatpickr-enabled)").each(function (
                e,
                a
              ) {
                var t = jQuery(a);
  ...
  function c(e, a) {
    return !a || ("object" !== i(a) && "function" != typeof a)
      ? (function (e) {
          if (void 0 === e)
        ...
        (o = [
          ...
          },
          {
            ...
            value: function (e) {
              var a = this;
              "init" === e
                ? (a._lPage.addClass("side-trans-enabled"),
                  this._uiHandleSidebars())
                : a._lPage.hasClass("side-scroll")
                ? (a._lSidebar.length > 0 &&
                    !a._lSidebarScroll &&
                    ((a._lSidebarScroll = new SimpleBar(
                      a._lSidebarScrollCon[0]
                    )),
                    jQuery(
                      ".simplebar-content-wrapper",
                      a._lSidebar
                    ).scrollLock("enable")),
                  a._lSideOverlay.length > 0 &&
                    !a._lSideOverlayScroll &&
                    ((a._lSideOverlayScroll = new SimpleBar(
                      a._lSideOverlay[0]
                    )),
                    jQuery(
                      ".simplebar-content-wrapper",
                ...
                : (a._lSidebar &&
                    ...
                    a._lSidebarScroll.unMount(),
                    (a._lSidebarScroll = null),
                    a._lSidebarScrollCon
                      .removeAttr("data-simplebar")
                      .html(jQuery(".simplebar-content", a._lSidebar).html())),
                  a._lSideOverlay &&
                    a._lSideOverlayScroll &&
                    (jQuery(
                      ".simplebar-content-wrapper",
                    ...
                    a._lSideOverlayScroll.unMount(),
                    (a._lSideOverlayScroll = null),
                    a._lSideOverlay
                      .removeAttr("data-simplebar")
                      .html(
                        jQuery(".simplebar-content", a._lSideOverlay).html()
                      )));
            },
          },
          {
                  ...
                  function (e) {
                    ...
                    if (
                      ...
                      o.hasClass("open")
                        ...
                        : (t.closest("ul").children("li").removeClass("open"),
                          o.addClass("open"),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (t) {
                var o = Cookies.get("oneuiThemeName") || !1;
                ...
                this._lPage.on(
                  ...
                  function (o) {
                    ...
                    jQuery('[data-toggle="theme"]').removeClass("active"),
                      ...
                      a.updateTheme(e, r),
                      (e = jQuery("#css-theme")),
                      t && Cookies.set("oneuiThemeName", r, { expires: 7 }),
                      n.trigger("blur");
                  }
                );
            },
              ...
              var o = {
                init: function () {
                  t._lPage.off("click.pixelcave.layout"),
                    t._lPage.off("click.pixelcave.overlay"),
                    t._lPage.on(
                ...
                sidebar_toggle: function () {
                  t._windowW > 991
                    ...
                    : t._lPage.toggleClass("sidebar-o-xs");
                },
                ...
                sidebar_close: function () {
                  t._windowW > 991
                    ...
                    : t._lPage.removeClass("sidebar-o-xs");
                },
                ...
                side_overlay_close: function () {
                  jQuery(document).off("keydown.pixelcave.sideOverlay"),
                    t._lPage.removeClass("side-overlay-o");
                },
                ...
                header_mode_toggle: function () {
                  t._lPage.toggleClass("page-header-fixed");
                },
                header_mode_static: function () {
                  t._lPage.removeClass("page-header-fixed");
                },
                ...
                header_search_off: function () {
                  t._lHeaderSearch.removeClass("show"),
                    t._lHeaderSearchInput.trigger("blur"),
                ...
                u = {
                  ...
                  fullscreen_toggle: function () {
                    e
                      ...
                      a.length &&
                        (e.hasClass("block-mode-fullscreen")
                          ? jQuery("i", a).removeClass(i).addClass(s)
                          : jQuery("i", a).removeClass(s).addClass(i));
                  },
                  fullscreen_on: function () {
                    e
                      ...
                      jQuery(e).scrollLock("enable"),
                      a.length && jQuery("i", a).removeClass(i).addClass(s);
                  },
                  fullscreen_off: function () {
                    e.removeClass("block-mode-fullscreen"),
                      jQuery(e).scrollLock("disable"),
                      a.length && jQuery("i", a).removeClass(s).addClass(i);
                  },
                  content_toggle: function () {
                    e.toggleClass("block-mode-hidden"),
                      t.length &&
                        (e.hasClass("block-mode-hidden")
                          ? jQuery("i", t).removeClass(c).addClass(d)
                          : jQuery("i", t).removeClass(d).addClass(c));
                  },
                  content_hide: function () {
                    e.addClass("block-mode-hidden"),
                      t.length && jQuery("i", t).removeClass(c).addClass(d);
                  },
                  content_show: function () {
                    e.removeClass("block-mode-hidden"),
                      t.length && jQuery("i", t).removeClass(d).addClass(c);
                  },
